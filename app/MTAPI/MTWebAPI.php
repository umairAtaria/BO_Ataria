...
use MTAPI\Mt5_Api\MTLogger;
use MTAPI\Mt5_Api\MT5CryptAes256;
use MTAPI\Mt5_Api\MTUtils;
use MTAPI\Mt5_Api\MTProtocolConsts;
use MTAPI\Mt5_Api\MTAuthProtocol;
use MTAPI\Mt5_Api\MTRetCode;
use MTAPI\Mt5_Api\MTConnect;
use MTAPI\Mt5_Api\MTJson;
use MTAPI\Mt5_Api\MTTimeProtocol;
use MTAPI\Mt5_Api\MTCommonProtocol;
use MTAPI\Mt5_Api\MTGroupProtocol;
use MTAPI\Mt5_Api\MTSymbolProtocol;
use MTAPI\Mt5_Api\MTUserProtocol;
use MTAPI\Mt5_Api\MTUser;
use MTAPI\Mt5_Api\MTOrderProtocol;
use MTAPI\Mt5_Api\MTPositionProtocol;
use MTAPI\Mt5_Api\MTDealProtocol;
use MTAPI\Mt5_Api\MTHistoryProtocol;
use MTAPI\Mt5_Api\MTTickProtocol;
use MTAPI\Mt5_Api\MTMailProtocol;
use MTAPI\Mt5_Api\MTPingProtocol;
use MTAPI\Mt5_Api\MTTradeProtocol;
use MTAPI\Mt5_Api\MTServerProtocol;
use MTAPI\Mt5_Api\MTCustomProtocol;
use MTAPI\Mt5_Api\MTNewsProtocol;
use MTAPI\Mt5_Api\MTOrderJson;
use MTAPI\Mt5_Api\MTEnDealAction;
use MTAPI\Mt5_Api\MTConGroupSymbol;
use MTAPI\Mt5_Api\MTEnOrderFlags;
use MTAPI\Mt5_Api\MTConSymbol;
use MTAPI\Mt5_Api\MTEnMarginRateTypes;
...
class MTWebAPI
{
   ...
   * @return MTRetCode
   */
  public function BatchAccountGet($group, &$logins)
  {
    $mt_user = new MTUserProtocol($this->m_connect);
    return $mt_user->BatchAccountGet($group, $logins);
  }
   ...
   * @return MTRetCode
   */
  public function DealGetPageByGroup($from, $to, $group, &$deals)
  {
    $mt_deal = new MTDealProtocol($this->m_connect);
    return $mt_deal->DealGetPageByGroup($from, $to, $group, $deals);
  }
