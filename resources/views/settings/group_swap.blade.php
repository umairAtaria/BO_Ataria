...
@section('content')
            ...
            <div class="col-md-12 col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title mx-4">Groups List</h3>
                        <button class="btn btn-primary sync">Import Groups</button>
                    </div>
    ...
    <script>
        $(document).on('click', '.sync', function() {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: 'This will replace all existing groups!',
                icon: 'warning',
        ...
        $(document).ready(function() {
            ...
            $('#search_value').on('keyup', function() {
                t4.setFilter([
                    {field:"Group", type:"like", value:$(this).val()},
