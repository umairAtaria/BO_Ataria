                ...
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        <a class="logo-horizontal " href="index.html">
                            ...
                            <img src="{{ asset('logo.png') }}" class="header-brand-img light-logo1" alt="logo">
                        </a>
                        <!-- LOGO -->
                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('mt5_connection') }}"><i
                                        class="side-menu__icon fe fe-zap"></i><span class="side-menu__label">MT5
                                        Connection</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('symbols') }}"><i
                                        class="side-menu__icon bi bi-cash-coin"></i><span class="side-menu__label">Universal Symbols</span>
                                </a>
                            </li>

                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('swap_update_index') }}"><i
                                        class="side-menu__icon bi bi-coin"></i><span class="side-menu__label">Swap Update</span>
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('group_swap') }}"><i
                                        class="side-menu__icon bi bi-people"></i><span class="side-menu__label">Group Swaps</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide"
                                    href="{{ route('translations') }}"><i
                                        class="side-menu__icon bi bi-clipboard-data"></i><span class="side-menu__label">Translations</span>
                                </a>
                            </li>
                                                        ...
                                                        <div class="Annoucement_card">
                                                            <div class="text-center">
                                                                <div>
                                                                    ...
                                                                    <div class="bg-layer">
                                                                        <img src="{{ asset('assets/images/media/37.png') }}"
                                                                            alt="img"
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © <span id="year"></span> . Designed
                        with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> 4XPORTAL
